...
public class TelaBusca extends AppCompatActivity
    ...
    public void botao1Click(View view){
        sessao.categoria = "Andador";
        Intent intent = new Intent(this, TelaResultadosBusca.class);
        startActivity(intent);
    }

    public void botao2Click(View view){
        sessao.categoria = "Bota ortopédica";
        Intent intent = new Intent(this, TelaResultadosBusca.class);
        startActivity(intent);
    }

    public void botao3Click(View view){
        sessao.categoria = "Cadeira de Rodas";
        Intent intent = new Intent(this, TelaResultadosBusca.class);
        startActivity(intent);
    }

    public void botao4Click(View view){
        sessao.categoria = "leito";
        Intent intent = new Intent(this, TelaResultadosBusca.class);
        startActivity(intent);
    }

    public void botao5Click(View view){
        sessao.categoria = "Medidor de Pressão";
        Intent intent = new Intent(this, TelaResultadosBusca.class);
        startActivity(intent);
    }

    public void botao6Click(View view){
        sessao.categoria = "Muleta";
        Intent intent = new Intent(this, TelaResultadosBusca.class);
        startActivity(intent);
    }

    public void botaoBusca(View view){
        SearchView busca = (SearchView) findViewById(R.id.txtBusca);
        sessao.categoria = busca.getQuery().toString();
        Toast.makeText(TelaBusca.this, sessao.categoria, Toast.LENGTH_SHORT).show();
    }
}
