...
public class TelaMinhasTransacoes extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_minhas_transacoes);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.tela_minhas_transacoes, menu);
        return true;
    }
